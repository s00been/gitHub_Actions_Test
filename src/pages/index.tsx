      ...
      <div className="mx-auto text-center">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex gap-x-1">
            <p className="rounded-[40px] text-[10px] leading-[18px]  text-gray-900 bg-[#efefef] w-[60px]">
              Trello
            </p>
            <p className="rounded-[40px]  text-[10px] leading-[18px]  text-gray-900 bg-[#efefef] w-[50px]">
              Git
            </p>
            <p className="rounded-[40px]  text-[10px] leading-[18px]  text-gray-900 bg-[#efefef] w-[60px]">
              Slack
          ...
          <div className="flex gap-x-1">
            ...
            <p className="rounded-[40px]  text-[10px] leading-[18px]  text-gray-900 bg-[#efefef] w-[80px]">
              Adobe XD
            </p>
          </div>
          <div className="flex gap-x-1">
          ...
          <div className="flex gap-x-1">
            ...
            <p className="rounded-[40px]  text-[10px] leading-[18px]  text-gray-900 bg-[#efefef] w-[90px]">
              Tailwind CSS
            </p>
            <p className="rounded-[40px]  text-[10px] leading-[18px]  text-gray-900 bg-[#efefef] w-[50px]">
              Next.js
